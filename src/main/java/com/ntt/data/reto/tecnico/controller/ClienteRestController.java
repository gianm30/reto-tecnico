package com.ntt.data.reto.tecnico.controller;

import com.ntt.data.reto.tecnico.bean.EncriptacionBean;
import com.ntt.data.reto.tecnico.exception.ValidacionBodyException;
...
public class ClienteRestController {
    ...
    @PutMapping("/")
    public ResponseEntity<?> modificar(@RequestParam(name = "codigo_unico") String codigoUnico, @Valid @RequestBody ClienteDTO clienteDTO, BindingResult validacion) {
        validarBody(validacion);
        clienteDTO.setCodigoUnico(codigoUnico);
